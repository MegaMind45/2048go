...
```js
javascript:(function () {var a = document.createElement('script');a.src = 'https://cdn.jsdelivr.net/gh/Browncha023/2048go@latest/script.min.js';document.body.appendChild(a);}())
```
